...
// Uses the AE_* prefix for macros (historical reasons), and the "SessionWire" namespace for symbols.

#ifndef Session_Wire_atomicops_h
#define Session_Wire_atomicops_h
